...
export function fromDecoded(obj: any): types.SpotFulfillmentConfigStatusKind {
...
export function fromJSON(
  obj: types.SpotFulfillmentConfigStatusJSON
): types.SpotFulfillmentConfigStatusKind {
  switch (obj.kind) {
    case "Enabled": {
      return new Enabled();
    }
