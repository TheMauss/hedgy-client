                ...
                <div className="w-full flex flex-col">
                  ...
                  <Graph 
                    ...
                    />
                                   ...
                                   <div className="w-full md:block hidden lg:h-[calc(100vh-100px)] overflow-auto">
                        <InterestBar
                                openingPrice={openingPrice}
                                symbol={symbol}
                                data={data}
                                ...
                                isSoliditySelected={isSoliditySelected}
                                      ...
                                      />
                                                      <div className=" w-full md:block flex-col hidden md:order-2 order-1 md:h-[629px] lg:h-[calc((100vh-100px)-(40vh+29px))] mt-2">
                  <Graph 
                    symbol={symbol}
                    latestOpenedPosition={latestOpenedPosition} 
                    prices={prices}
                    ...
                    /></div>
                                  <div className="w-full lg:flex lg:flex-col hidden order-3   lg:h-[calc((100vh-118px)-(60vh-74px))] mt-2">
                                    <MyPositionsFutures         
                     latestOpenedPosition={latestOpenedPosition}
                     ...
                     />
                                      ...
                                      <div className="lg:block hidden md:w-[315px] flex flex-col lg:h-[calc(100vh-110px)]">
