          ...
          <div className="flex md:flex-row flex-col flex justify-center items-center  md:w-[60%] w-[100%] relative z-1 md:gap-16 gap-32">
            <div className="bg-[#0B111B] h-[370px] md:w-[50%] w-[100%] md:max-w-[450px] sm:max-w-[370px] min-w-[300px] relative  z-10">
              <Link href="/futures?crypto=btc">
                <div className="inside_shadow bg-[#0B111B]  absolute border border-[#434665] border-solid bottom-[0] flex flex-col inset-x-[0] items-center justify-end mx-auto p-[42px] md:px-10 sm:px-5  rounded-[32px] w-full">
