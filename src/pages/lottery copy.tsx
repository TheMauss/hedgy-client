      ...
      <div className="flex justify-center items-top min-h-[calc(100vh-182px)] z-100 bg-layer-1 ">
        <div className="w-[95%] xl:w-[80%] lg:w-[80%] md:w-[80%] sm:min-w-[95%] ">
          <div className=" w-full  bg-layer-1 overflow-hidden text-left text-base text-neutral-06 font-gilroy-bold">
            ...
            >
              <div className="w-full flex flex-row items-center justify-between lg:px-4 lg:py-2 py-6 px-8 gap-[8px] md:rounded-2xl  lg:[backdrop-filter:blur(0px)] md:[backdrop-filter:blur(15px)] rounded-2xl">
                ...
                <div className="lg:w-[55%] md:w-4/5 py-2 px-8 rounded-2xl  h-[90px] flex flex-col items-center justify-center  box-border text-base font-gilroy-medium [backdrop-filter:blur(20px)] ">
            ...
            <div className=" flex md:flex-row flex-col gap-6 mt-6">
              ...
              <div
                className="md:hidden max-h-[200px] flex-1 flex flex-col p-6 gap-3 rounded-2xl  overflow-hidden"
                style={{
                  backgroundImage: "url('/frame-2085660304@3x.png')",
                  backgroundSize: "cover",
                  backgroundRepeat: "no-repeat",
