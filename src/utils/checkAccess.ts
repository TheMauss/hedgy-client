...
export async function hasAccess(publicKey: PublicKey | null): Promise<boolean> {
  ...
  const allowedPublicKeys = [
    ...
    "656TeseqzeaATZCR32uqj8UUk6GB7u9KPubmZbksRyWM",
    "BzacChrDhjnp1UF29dxUwj9AtcW4bBHU8idSu1WQuoM",
    "5JUm3KySSrgctgiH5fz9qKKtkjQEEZgmBJ4mNRSZeZVK",
    "E92bhtH7iLWEPkvrvoMe43MgDecCH2nArPck5xVmroAx",
    "GQduaSYxBEeiEq9SxzGUX32hkxbZREjHW1zttbf7UQWT",
    "4cWdsDtx9Ne3C63NpYsftreg9TBSpKvfpLjBW92tG7Wj",
    "BLpQuU6n1jrLcRkrpoftwnv3UHvCBRGkuHQTAjRUaU4w",
  ];
