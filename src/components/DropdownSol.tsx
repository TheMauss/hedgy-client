      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-2">
        ...
        >
          <span className="opacity-70">
            Hedgy is a fully automated, SOL exposure strategy built on top of
            ...
            against volatility, ensuring steady yield growth for your SOL
            investments.{" "}
            <span>
              You can track the portfolio on
              <a
                href="https://app.drift.trade/overview/portfolio?authority=86fYXDydyKKnL7gxWpVrUDnsrVyQyZkwb4YsisBHC9ab&fbclid/"
                target="_blank"
