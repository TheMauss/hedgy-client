...
import ChartComponent from "./CustomChartOpTV";
...
const Graph: React.FC<GraphProps> = ({ prices, latestOpenedPosition, symbol }) => { // You forgot to add latestOpenedPosition here
  return (
