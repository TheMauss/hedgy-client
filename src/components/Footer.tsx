...
export const Footer: FC = () => {
  ...
  return (
    <div className="flex justify-center bg-layer-1 ">
      <div className="h-9.5 py-[26px] text-gray-200 flex items-center justify-between  w-[95%] xl:w-[80%] lg:w-[80%] md:w-[80%] sm:min-w-[95%] flex flex-row items-center justify-between text-mini-7">
